...
function saveSaisie() {
  ...
  var obj = {
    ...
    huiles: getHuiles(),
    pneuAvg: {statut:document.getElementById('sPneuAvgStatut').value, ref:document.getElementById('sPneuAvgRef').value, fourn:document.getElementById('sPneuAvgFourn').value, etat:document.getElementById('sPneuAvgEtat').value, prix:+(document.getElementById('sPneuAvgPrix').value||0)},
    pneuAvd: {statut:document.getElementById('sPneuAvdStatut').value, ref:document.getElementById('sPneuAvdRef').value, fourn:document.getElementById('sPneuAvdFourn').value, etat:document.getElementById('sPneuAvdEtat').value, prix:+(document.getElementById('sPneuAvdPrix').value||0)},
    pneuArg: {statut:document.getElementById('sPneuArgStatut').value, ref:document.getElementById('sPneuArgRef').value, fourn:document.getElementById('sPneuArgFourn').value, etat:document.getElementById('sPneuArgEtat').value, prix:+(document.getElementById('sPneuArgPrix').value||0)},
    pneuArd: {statut:document.getElementById('sPneuArdStatut').value, ref:document.getElementById('sPneuArdRef').value, fourn:document.getElementById('sPneuArdFourn').value, etat:document.getElementById('sPneuArdEtat').value, prix:+(document.getElementById('sPneuArdPrix').value||0)},
...
function loadSaisieToForm(x) {
  ...
  document.getElementById('sPneuAvgFourn').value = pAvg.fourn||''; document.getElementById('sPneuAvgEtat').value = pAvg.etat||''; document.getElementById('sPneuAvgPrix').value = pAvg.prix||'';
  document.getElementById('sPneuAvdStatut').value = pAvd.statut||'OK'; document.getElementById('sPneuAvdRef').value = pAvd.ref||'';
  document.getElementById('sPneuAvdFourn').value = pAvd.fourn||''; document.getElementById('sPneuAvdEtat').value = pAvd.etat||''; document.getElementById('sPneuAvdPrix').value = pAvd.prix||'';
  document.getElementById('sPneuArgStatut').value = pArg.statut||'OK'; document.getElementById('sPneuArgRef').value = pArg.ref||'';
  document.getElementById('sPneuArgFourn').value = pArg.fourn||''; document.getElementById('sPneuArgEtat').value = pArg.etat||''; document.getElementById('sPneuArgPrix').value = pArg.prix||'';
  document.getElementById('sPneuArdStatut').value = pArd.statut||'OK'; document.getElementById('sPneuArdRef').value = pArd.ref||'';
  document.getElementById('sPneuArdFourn').value = pArd.fourn||''; document.getElementById('sPneuArdEtat').value = pArd.etat||''; document.getElementById('sPneuArdPrix').value = pArd.prix||'';
  // Flexibles
  document.getElementById('flexiblesContainer').innerHTML = '';
...
function spSwitchTab(tab, el) {
  ['Ref','Type','Engin','Histo'].forEach(function(t){ var d=document.getElementById('spTab'+t); if(d) d.style.display=(t===tab?'':'none'); });
...
function runSuiviPneus() {
  ...
  var refMap={}, typeMap={}, enginMap={}, histoList=[];
  ...
  document.getElementById('spHistoTable').innerHTML=histoList.length?histoList.map(function(h,i){
    ...
    return '<tr style="background:'+(i%2===0?'rgba(255,255,255,.03)':'transparent')+'">'
      ...
      +'</tr>';
  }).join(''):'<tr><td colspan="12" class="text-center text-muted py-3">Aucun changement de pneu enregistr\u00e9 sur cette p\u00e9riode.</td></tr>';
}
